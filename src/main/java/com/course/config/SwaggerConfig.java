...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.course.resources")).paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
			 ...
			 new Contact("Antônio Penizollo", "github.com/antoniopenizollo/backend-spring", "antoniopenizollo@gmail.com"),
