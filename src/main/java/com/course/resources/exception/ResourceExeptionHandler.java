...
import com.course.services.exceptions.AuthorizationException;
import com.course.services.exceptions.DataIntegrityException;
import com.course.services.exceptions.FileException;
...
public class ResourceExeptionHandler {
	...
	public ResponseEntity<StandardError> s3(AmazonS3Exception e, HttpServletRequest request){
		StandardError err = new StandardError(HttpStatus.BAD_REQUEST.value(), e.getMessage(), System.currentTimeMillis());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
